    ...
    <form id="saveForm" method="POST" action="edit/save">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <tr>
                    <td>
                        <input id="name" type="text" class="form-control{{ $errors->has('name')? ' is-invalid': ''}}" name="name" value="{{ $profession->name }}" required>
                        @if ($errors->has('name'))
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <tr>
                    <td>
                        <input id="strength" type="text" class="form-control{{ $errors->has('strength') ? ' is-invalid' : '' }}" name="strength" value="{{ $profession->strength }}">
                    ...
                    <td>
                        <input id="agility" type="text" class="form-control{{ $errors->has('agility') ? ' is-invalid' : '' }}" name="agility" value="{{ $profession->agility }}">
                    ...
                    <td>
                        <input id="resistance" type="text" class="form-control{{ $errors->has('resistance') ? ' is-invalid' : '' }}" name="resistance" value="{{ $profession->resistance }}">
                    ...
                    <td>
                        <input id="mindfullness" type="text" class="form-control{{ $errors->has('mindfullness') ? ' is-invalid' : '' }}" name="mindfullness" value="{{ $profession->mindfullness }}">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <tr>
                    <td>
                        <input id="intelligence" type="text" class="form-control{{ $errors->has('intelligence') ? ' is-invalid' : '' }}" name="intelligence" value="{{ $profession->intelligence }}">
                    ...
                    <td>
                        <input id="wisdom" type="text" class="form-control{{ $errors->has('wisdom') ? ' is-invalid' : '' }}" name="wisdom" value="{{ $profession->wisdom }}">
                    ...
                    <td>
                        <input id="intuition" type="text" class="form-control{{ $errors->has('intuition') ? ' is-invalid' : '' }}" name="intuition" value="{{ $profession->intuition }}">
                    ...
                    <td>
                        <input id="charisma" type="text" class="form-control{{ $errors->has('charisma') ? ' is-invalid' : '' }}" name="charisma" value="{{ $profession->charisma }}">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <tr>
                    <td>
                        <textarea id="description" type="text" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description">{{ $profession->description }}</textarea>
